...
exports.getAllCustomers = async (req, res, next) => {    //фильтрует только по email 
  try {
...
exports.updateCustomer = async (req, res, next) => {    // вызывает реальный метод update сервиса и возвращает обновленного клиента 
  try {
    const { id } = req.params;
